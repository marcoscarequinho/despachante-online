      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="font-bold text-xl text-primary">DETRAN Digital</h1>
              <p className="text-sm text-muted-foreground">Despachante Marcos Carequinho</p>
              <p className="text-xs text-muted-foreground/80">Credenciado DETRAN RJ • ES • MG • SP • MS • PR</p>
            </div>
          </div>
