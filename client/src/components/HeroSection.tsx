      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <div className="mb-4">
              ...
              <p className="text-sm lg:text-base text-white/80">
                Credenciado ao DETRAN RJ • ES • MG • SP • MS • PR
              </p>
            </div>
            
            <h1 className="text-4xl lg:text-6xl font-bold mb-6 text-primary-foreground leading-tight">
            ...
            <p className="text-xl lg:text-2xl mb-8 text-primary-foreground/90 font-medium">
              Entre Estados RJ, SP, ES, MG, MS, PR
            </p>
            
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 mb-8">
              <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full">
                <Shield className="w-5 h-5 text-white" />
                <span className="text-white font-medium">Processo Seguro</span>
              </div>
              <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full">
              ...
              <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full">
                ...
                <span className="text-white font-medium">Confiável</span>
              </div>
            </div>

            <div className="bg-white/15 backdrop-blur-sm p-6 rounded-2xl mb-8 border border-white/20">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button 
                ...
                className="text-lg px-8 py-4 h-auto bg-success-green hover:bg-success-green/90 transition-bounce shadow-medium hover:shadow-large"
              >
              ...
              <Button 
                ...
                variant="outline"
                className="text-lg px-8 py-4 h-auto bg-white/20 border-white/30 text-white hover:bg-white/30 backdrop-blur-sm transition-smooth"
              >
                Ver Serviços
              </Button>
            </div>
          ...
          <div className="relative space-y-6">
            {/* Links Úteis DETRAN */}
            <div className="bg-white/10 backdrop-blur-sm p-6 rounded-2xl border border-white/20 text-center mb-6">
              <Dialog>
                <DialogTrigger asChild>
                  <Button className="w-full mb-4 bg-red-600 hover:bg-red-700 text-white font-semibold py-3">
                    🔗 Links Úteis DETRAN: RJ, MG, ES, SP, MS, PR
                  </Button>
                </DialogTrigger>
                <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-3">
                      <h3 className="text-lg font-bold text-primary border-b pb-2">Rio de Janeiro</h3>
            ...
            <div className="bg-white/10 backdrop-blur-sm p-6 rounded-2xl border border-white/20 text-center">
              <a href="/app.apk" download="despachante-app.apk">
                <Button
                  className="w-full mb-4 bg-success-green hover:bg-success-green/90 text-white font-semibold py-3"
                >
            ...
            <div className="relative bg-white/10 backdrop-blur-sm p-8 rounded-3xl border border-white/20">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                <div className="bg-white/15 p-4 rounded-xl text-center">
                  <span className="text-2xl font-bold text-white block">RJ</span>
                  <span className="text-sm text-white/80">Rio de Janeiro</span>
                </div>
                <div className="bg-white/15 p-4 rounded-xl text-center">
                  <span className="text-2xl font-bold text-white block">SP</span>
                  <span className="text-sm text-white/80">São Paulo</span>
                </div>
                <div className="bg-white/15 p-4 rounded-xl text-center">
                  <span className="text-2xl font-bold text-white block">ES</span>
                  <span className="text-sm text-white/80">Espírito Santo</span>
                </div>
                <div className="bg-white/15 p-4 rounded-xl text-center">
                  <span className="text-2xl font-bold text-white block">MG</span>
                  <span className="text-sm text-white/80">Minas Gerais</span>
                </div>
                <div className="bg-white/15 p-4 rounded-xl text-center">
                  <span className="text-2xl font-bold text-white block">MS</span>
                  <span className="text-sm text-white/80">Mato Grosso do Sul</span>
                </div>
                <div className="bg-white/15 p-4 rounded-xl text-center">
                  <span className="text-2xl font-bold text-white block">PR</span>
                  <span className="text-sm text-white/80">Paraná</span>
                </div>
              </div>

              <div className="mt-6 text-center">
                <div className="inline-flex items-center gap-2 bg-success-green/20 text-success-green px-4 py-2 rounded-full border border-success-green/30">
                  <CheckCircle className="w-4 h-4" />
                  <span className="font-medium">Processo Aprovado</span>
                </div>
              </div>
            </div>

            {/* Floating elements */}
            <div className="absolute -top-4 -left-4 w-20 h-20 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center border border-white/30">
              <Shield className="w-8 h-8 text-white" />
            </div>
            
            <div className="absolute -bottom-4 -right-4 w-16 h-16 bg-success-green/20 backdrop-blur-sm rounded-full flex items-center justify-center border border-success-green/30">
