            ...
            <div className="bg-white p-6 rounded-2xl shadow-soft">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <button
                  ...
                  className="bg-success-green hover:bg-success-green/90 text-white px-6 py-3 rounded-lg font-medium transition-smooth flex items-center justify-center gap-2"
                >
                  Falar no WhatsApp
                </button>
                <button
                  onClick={() => window.open("tel:+5522992090682", "_blank")}
                  className="border border-primary text-primary hover:bg-primary hover:text-primary-foreground px-6 py-3 rounded-lg font-medium transition-smooth"
                >
                  Ligar Agora
                </button>
              </div>
