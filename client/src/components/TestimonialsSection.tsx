    ...
    <section id="depoimentos" className="py-20 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-primary p-8 rounded-2xl shadow-medium max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="text-3xl font-bold text-primary-foreground mb-1">1000+</div>
              ...
              <div className="text-center">
                ...
                <div className="text-primary-foreground/80 text-sm">Nota Média</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-primary-foreground mb-1">98%</div>
                <div className="text-primary-foreground/80 text-sm">Recomendação</div>
              </div>
            </div>
          </div>
        </div>
