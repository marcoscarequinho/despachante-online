      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-subtle p-6 rounded-2xl border">
                ...
                <DialogContent className="max-w-sm">
                  ...
                  <div className="flex flex-col items-center space-y-4">
                    <img 
                      src={pixQrCode} 
                      alt="QR Code PIX" 
                      className="w-48 h-48 border rounded-lg shadow-medium"
                    />
                    <div className="text-center">
                      <p className="text-sm text-muted-foreground mb-2">Chave PIX:</p>
                      <p className="font-mono font-bold text-primary">22992090682</p>
                    </div>
                  </div>
                </DialogContent>
              </Dialog>
              ...
              <div className="space-y-4">
                <Card className="border-success-green/20 bg-success-green/5">
                  <CardHeader className="pb-4">
                    <CardTitle className="flex items-center gap-3 text-success-green">
                  ...
                  <CardContent>
                    <Button 
                      ...
                      className="w-full bg-success-green hover:bg-success-green/90 text-white gap-2"
                    >
        ...
        <div className="mt-16">
          <div className="bg-gradient-primary p-8 rounded-2xl shadow-medium text-center text-primary-foreground">
